  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'page-enter': 'pageEnter 0.6s ease-out',
        'page-exit': 'pageExit 0.4s ease-in',
      ...
      keyframes: {
        ...
        pulseGlow: {
          ...
          '50%': { boxShadow: '0 0 60px rgba(59, 130, 246, 0.6), 0 0 100px rgba(236, 72, 153, 0.3)' },
        },
        slideUp: {
      ...
      backgroundImage: {
        ...
        'dark-gradient': 'linear-gradient(135deg, #0f172a 0%, #1e293b 50%, #1d4ed8 100%)',
