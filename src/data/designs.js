...
export const designs = [
  ...
  },
  {
    ...
    title: 'Logo Design 2',
    category: 'Branding',
    image: '/designs/port/Branding and Logos/logo12.png',
    description: 'Clean geometric logo concept with strong visual hierarchy.',
    tools: ['Illustrator'],
  },
  {
    id: 5,
    title: 'Logo Design 3',
    category: 'Branding',
    image: '/designs/port/Branding and Logos/logo13.png',
    description: 'Bold typographic logo with custom letterforms.',
    tools: ['Illustrator'],
  },
  {
    id: 6,
    title: 'Logo Design 4',
    category: 'Branding',
    image: '/designs/port/Branding and Logos/logo14.png',
    description: 'Icon-based logo mark designed for versatile use across platforms.',
    tools: ['Illustrator'],
  },
  {
    id: 7,
    title: 'Logo Design 5',
    category: 'Branding',
    image: '/designs/port/Branding and Logos/logo4.png',
    description: 'Combination mark logo balancing symbol and text for brand recognition.',
    tools: ['Illustrator'],
  },
  {
    id: 8,
