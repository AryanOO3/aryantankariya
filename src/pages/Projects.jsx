                  ...
                  <div className="relative glass-card rounded-3xl overflow-hidden glass-hover group-hover:border-primary-500/50">
                    ...
                    <div className="px-6 pb-6">
                      <div className="flex items-center justify-between pt-4 border-t border-white/10">
                        ...
                        <Link to={`/projects/${project.slug}`} className="group/link flex items-center text-sm text-black/60 dark:text-white/60 hover:text-primary-400 transition-colors duration-300">
                          <span>Details</span>
